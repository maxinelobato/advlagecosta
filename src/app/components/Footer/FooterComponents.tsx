...
export function FooterBg(props: FooterBgProps) {
  return (
    <>
      <footer className="bg-black/90" {...props} />
    </>
  )
}
...
export function FooterButtonAnchor(props: FooterButtonAnchorProps) {
  return (
    <a
      ...
      className="focus:shadow-outline hover:bg-brandBlue500/10 inline-flex h-16 w-full items-center justify-center rounded-md bg-transparent px-4 py-6 font-medium tracking-wide text-white shadow-lg hover:transition-colors focus:outline-none sm:h-14 md:w-auto"
      {...props}
    />
  )
}
