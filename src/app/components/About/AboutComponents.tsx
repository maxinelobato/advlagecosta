...
export function AboutSection(props: AboutSectionProps) {
  return (
    <section
      className="bg-brandBlue900 relative flex flex-col-reverse bg-scroll py-16 lg:flex-col lg:pb-0 lg:pt-0"
      {...props}
    />
  )
}
...
export function AboutParagraphArticleOne(props: AboutParagraphArticleOneProps) {
  return <p className="pb-5 pr-5 text-sm text-white md:text-lg" {...props} />
}
...
export function AboutParagraphArticleTwo(props: AboutParagraphArticleTwoProps) {
  return <p className="pb-2 pr-5 text-sm text-white md:text-lg" {...props} />
}
