...
export function SocialProveSpan(props: SocialProveSpanProps) {
  return <span className="font-black text-white/80 sm:block" {...props} />
}
...
export function SocialProveClientNameParagraph(
  ...
  return <p className="mt-0.5 text-lg font-bold text-black/80" {...props} />
}
...
export function SocialProveClientProveParagraph(
  ...
  return <p className="mt-4 font-medium text-black/90" {...props} />
}
